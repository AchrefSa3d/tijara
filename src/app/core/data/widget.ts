...
const tileBoxs3 = [
    ...
    },
    {
        ...
        labelClass: "white-50",
        counterClass: "text-white",
        badgeClass: "bg-light-subtle text-body",
        badge: "ri-arrow-down-line",
        percentage: "0.24 %",
        iconClass: "bg-white bg-opacity-25",
        feaIcon: "clock",
...
const tileBoxs4 = [
    {
        ...
        percentage: "6.11 %",
        percentageClass: "bg-white bg-opacity-25",
    ...
    },
    {
        ...
        captionClass: "muted",
        percentage: "10.35 %",
        percentageClass: "bg-danger-subtle text-danger",
    ...
    },
    {
        ...
        captionClass: "muted",
        percentage: "22.96 %",
        percentageClass: "bg-success-subtle text-success",
        badge: "ri-arrow-up-s-line",
        decimals: 2,
        separator: ",",
        suffix: "",
...
const widgetsTasks = [
    ...
    },
    {
        id: 6,
        forId: "task_six",
        text: "Styling wireframe design and documentation for TIJARA admin",
        date: "27 Sep, 2021",
    },
];
